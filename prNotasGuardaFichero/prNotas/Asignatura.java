...
public class Asignatura  {
    ...
    public void guardaDatos(Set<Alumno> set, String nombreFichero) throws FileNotFoundException{
        try(PrintWriter pw  = new PrintWriter(nombreFichero)){
            guardaDatos(set, pw);
        }
    }
    public void guardaDatos(Set<Alumno> set, PrintWriter pw){
        for(Alumno alumno : set){
            pw.println(alumno);
        }
    }
}
